...
//If the returned function is invoked with no arguments before any numbers are passed in, 
...
function average() {
    ...
    let avgCal = (num) => {
        ...
        if(divisor == 0) return 0   // if no number enter so far
...
console.log(avgSoFar()); // => should log 8
console.log(avgSoFar(2)); // => should log 6.5
